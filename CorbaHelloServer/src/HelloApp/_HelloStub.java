...
public class _HelloStub extends org.omg.CORBA.portable.ObjectImpl implements HelloApp.Hello
{
  ...
  public String hellomessage ()
  {
            ...
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("_get_hellomessage", true);
                $in = _invoke ($out);
  ...
  public void hellomessage (String newHellomessage)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("_set_hellomessage", true);
                $out.write_string (newHellomessage);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
